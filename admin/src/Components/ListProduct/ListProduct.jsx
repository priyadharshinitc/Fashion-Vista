...
const ListProduct = () => {
  ...
  return (
    <div className='list-product flex flex-col items-center w-full h-[740px] py-2 px-12 m-8 rounded-sm bg-neutral-100 max-md:box-border max-md:w-[95%] max-md:h-full max-md:py-2 max-md:px-8 max-md:my-5 max-md:mx-auto'>
      <h1 className='text-2xl font-bold'>All Products List</h1>
      <div className="listproduct-format-main grid grid-cols-[1fr_3fr_1fr_1fr_1fr_1fr] gap-2 w-full py-5 px-0 text-[#454545] text-base font-semibold max-md:py-4 max-md:px-0">
        <p>Products</p>
        <p>Title</p>
        <p>Old Price</p>
        <p>New Price</p>
