...
const Item = (props) => {
  return (
    <div className='item w-[350px] hover:scale-[1.05] hover:transition duration-[0.6s] max-xl:w-[220px] max-xl:text-base max-lg:w-[170px] max-md:w-[120px] max-sm:w-[160px]'>
