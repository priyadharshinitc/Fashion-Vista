...
const Popular = () => {
  return (
    <div className='popular flex flex-col items-center gap-2  mt-10  max-md:gap-2'>
        ...
        <div className="popular-item w-[80%] flex justify-center gap-8 mt-[50px] max-xl:g-5 max-xl:mt-[30px] max-lg:gap-4 max-lg:mt-[20px] max-md:gap-1 max-sm:grid max-sm:grid-cols-2 max-sm:gap-5">
