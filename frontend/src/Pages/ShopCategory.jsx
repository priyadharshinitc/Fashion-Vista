...
const ShopCategory = (props) => {
  ...
  return (
    <div className='shop-category'>
      <img className='shopcategory-banner block w-[82%] my-[30px] mx-[30px] max-xl:my-5 max-xl:w-[90%] max-md:w-[95%] max-sm:mx-[10px]' src={props.banner} alt="Banner Image" />
      ...
      <div className='shopcategory-products grid grid-cols-4 items-center gap-20 my-8 mx-[30px] max-xl:w-[90%] max-xl:my-2 max-xl:gap-x-10 max-md:w-[95%] max-sm:grid-cols-2 max-sm:mx-[10px]'>
